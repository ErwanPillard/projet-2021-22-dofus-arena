...
void initialisationClasses(Classe *classe){
    ...
    classe[0].valide = al_load_bitmap("../Image/bouttonStart.png");
    ...
    classe[0].rectangle[VALIDER].hauteur = 73;
    classe[0].rectangle[VALIDER].largeur = 165;
    ...
    classe[0].rectangle[CLASSE1].x = 600;
    ...
    classe[0].rectangle[CLASSE2].x = 655;
    classe[0].rectangle[CLASSE2].y = 700;
    classe[0].rectangle[CLASSE2].color = BLANC;

    classe[0].rectangle[CLASSE3].hauteur = 50;
    classe[0].rectangle[CLASSE3].largeur = 50;
    classe[0].rectangle[CLASSE3].x = 710;
    classe[0].rectangle[CLASSE3].y = 700;
    classe[0].rectangle[CLASSE3].color = BLANC;
    ...
    classe[1].valide = al_load_bitmap("../Image/bouttonStart.png");
    ...
    classe[1].rectangle[VALIDER].hauteur = 73;
    classe[1].rectangle[VALIDER].largeur = 165;
    ...
    classe[2].valide = al_load_bitmap("../Image/bouttonStart.png");
    classe[2].rectangle[VALIDER].hauteur = 73;
    classe[2].rectangle[VALIDER].largeur = 165;
    classe[2].rectangle[VALIDER].x = 1200;
    classe[2].rectangle[VALIDER].y = 700;
    classe[2].rectangle[VALIDER].color = VERT;
}
...
void dessinerImageFond(int classeEnCours, Classe classe[]){
    switch (classeEnCours) {
        case 0:{
            ...
            al_draw_scaled_bitmap(classe[0].valide, 0, 0, 330, 146, classe[0].rectangle[VALIDER].x, classe[0].rectangle[VALIDER].y, classe[0].rectangle[VALIDER].largeur,classe[0].rectangle[VALIDER].hauteur, 0);
            break;
        }
        case 1:{
            ...
            al_draw_scaled_bitmap(classe[1].valide, 0, 0, 330, 146, classe[1].rectangle[VALIDER].x, classe[1].rectangle[VALIDER].y, classe[1].rectangle[VALIDER].largeur,classe[1].rectangle[VALIDER].hauteur, 0);
            break;
        }
        case 2:{
            ...
            al_draw_scaled_bitmap(classe[2].valide, 0, 0, 330, 146, classe[2].rectangle[VALIDER].x, classe[2].rectangle[VALIDER].y, classe[2].rectangle[VALIDER].largeur,classe[2].rectangle[VALIDER].hauteur, 0);
            break;
        }
    }
}
...
void dessinerInterfaceClasses(Classe classe[], int classeEnCours, int posJoueur){
    ...
    for (int i = 0; i < 4; i++) { // 0 a 5 jusqu'au enum VALIDER
        ...
        while(!end){
            ...
            switch (event.type) {
                ...
                case ALLEGRO_EVENT_MOUSE_AXES: {
                    if (surPassageCase(event.mouse.x, event.mouse.y, classe[classeEnCours].rectangle[VALIDER])){
                        classe[classeEnCours].rectangle[VALIDER].color = VERTfonce;////////a modif
                    }
                    else{
                        classe[classeEnCours].rectangle[VALIDER].color = VERT;
                    }
